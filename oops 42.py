...
class Food:
    ...
    def __init__(self, parent_screen, game_level):
        ...
        if game_level==0:
            ...
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food0.jpg').convert()

        if game_level==1:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food1.jpg').convert()

        elif game_level==2:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food2.jpg').convert()

        elif game_level==3:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food3.jpg').convert()

        elif game_level==4:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food4.jpg').convert()

        elif game_level==5:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food5.jpg').convert()

        elif game_level==6:
            self.food=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\food6.jpg').convert()
...
class Snake:
    ...
    def __init__(self, parent_screen, length, game_level):
        ...
        if game_level==0:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial0.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block0.png').convert()

        elif game_level==1:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial1.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block1.png').convert()

        elif game_level==2:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial2.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block2.png').convert()

        elif game_level==3:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial3.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block3.png').convert()

        elif game_level==4:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial4.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block4.png').convert()

        elif game_level==5:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial5.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block5.png').convert()

        elif game_level==6:
            self.block_initial=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block_initial6.png').convert()
            self.block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\block6.png').convert()
    ...
    def last_border(self):
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_side.jpg').convert()
    ...
    def walk2(self):
        self.last_border()
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_block2.jpg').convert()
    ...
    def walk3(self):
        self.last_border()
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_block3.jpg').convert()
    ...
    def walk4(self):
        self.last_border()
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_block4.jpg').convert()
    ...
    def walk5(self):
        self.last_border()
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_block5.png').convert()
    ...
    def walk6(self):
        self.last_border()
        self.border_block=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\border_block6.jpg').convert()
...
class Game:
    ...
    def moving_keys(self, level):
        ...
        if level==0:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up0.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down0.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left0.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right0.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause0.png').convert()

        if level==1:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up1.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down1.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left1.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right1.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause1.png').convert()

        elif level==2:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up2.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down2.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left2.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right2.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause2.png').convert()

        elif level==3:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up3.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down3.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left3.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right3.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause3.png').convert()

        elif level==4:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up4.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down4.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left4.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right4.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause4.png').convert()

        elif level==5:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up5.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down5.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left5.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right5.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause5.png').convert()

        elif level==6:
            self.key_up = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_up6.png').convert()
            self.key_down = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_down6.png').convert()
            self.key_left = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_left6.png').convert()
            self.key_right = pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_right6.png').convert()
            self.key_pause=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\key_pause6.png').convert()
    ...
    def show_game_over(self, level_high_score, extra_score, time, roundd, extra):
        self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_game_over.jpg')
    ...
    def background_music(self):
        pygame.mixer.music.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\tune_of_backgrond.mp3')
        pygame.mixer.music.play(-1, 0) #-1=continuos music, 0=music from starting

    def play_sound(self, sound):
        if sound=='food':
            sound=pygame.mixer.Sound('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\tune_of_food.mp3')
        if sound=='crash':
            sound=pygame.mixer.Sound('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\tune_of_crash.mp3')
        pygame.mixer.Sound.play(sound)
        
    def play(self, level, time, roundd, extra):
        if level==0:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background0.jpg')
            self.snake.walk1()

        if level==1:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background1.jpg')
            self.snake.walk1()

        if level==2:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background2.jpg')
            self.snake.walk2()

        if level==3:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background3.jpg')
            self.snake.walk3()

        if level==4:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background4.jpg')
            self.snake.walk4()

        if level==5:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background5.jpg')
            self.snake.walk5()

        if level==6:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_background6.jpg')
            self.snake.walk6()

        self.food.draw()

        if level==0:
            self.display_score('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\classic_high_score.txt', level, time, roundd, extra)

        else:
            self.display_score('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\campaign_high_score.txt', level, time, roundd, extra)
    ...
    def show_high_score(self):
        self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_score.jpg')

        with open('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\classic_high_score.txt', 'r') as classic_h_score:
            for i in classic_h_score:
                i=i.strip()
                p=i.split(' ')
        
        with open('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\campaign_high_score.txt', 'r') as campaign_h_score:
    ...
    def run(self):
        ...
        while page1:
            ...
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_menu.jpg')
            color = (0, 0, 0)
        ...
        if page6:
            self.page_background('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\page_level.jpg')
            running=True
            while running:
        ...
        if page4:
            ...
            if LEVEL==0:
                self.show_game_over('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\classic_high_score.txt', 0, TIME, ROUND, EXTRA)

            else:
                self.show_game_over('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\campaign_high_score.txt', int((LEVEL-1)*(10/TIME)), TIME, ROUND, EXTRA)
...
if __name__=='__main__':
    ...
    Icon=pygame.image.load('E:\\Programming\\Programs\\.vscode\\Extras\\Resourses\\SnaCaKeImage.png')
